...
public class Simulation {
    ...
    private void run(Network network) {
        ...
        while (time < MAX_TIME) {
        	 ...
        	 * 										(2.: kdTree bauen)
        	 * 										(3.: F�r alle Vehicles: vehicle.update(neighboursToConsider
        	 * 												dann veh.move()
        	 * 												dann vehicleInfo() )
        	 * 
        	 * Entscheidung:  ENTWEDER____________wir m�ssen jedes mal wenn wir feststellen dass mind. ein vehicle gefinished ist den kdTree neu bauen
        	 * 											=> teuer
        	 * 				  ODER________________wir ignorieren dass ein veh vllt schon drau�en ist und lassen die socialforces zu/von ihm trotzdem
        	 * 									  bis zum n�chsten Bau von kdTree berechnen
        	 * 											=> billig aber ungenau
        	 *
        	 * momentan umgesetzt ist erstere option, aber gerade wenn viele agenten unterwegs sind wird das wohl dazu f�hren,
